...
const mostrarCodigoCreado = () => {         
    ...
    document.getElementById("encryptedkeyword").innerHTML = window.cipher.encode(offset, string);
}
...
const enlacePuerta = document.getElementById("enlacePuerta");
    ...
    document.getElementById("decryptedword").innerHTML=window.cipher.decode(offset2, palabraEncriptada);
}   
